...
interface ServicePeopleServiceGetRandomArgs {
    age: number;
}

interface ServicePeopleServiceGetRandomReturns {
    person: Person;
}
...
export interface PeopleService {
	// method.type normal
  getRandom: (
		args: ServicePeopleServiceGetRandomArgs,
		opts?: CallServiceOptions
	) => Promise<ServicePeopleServiceGetRandomReturns>;
}
...
export function createPeopleService(host: string): PeopleService {
    return {
        getRandom: (
            args: ServicePeopleServiceGetRandomArgs,
            opts?: CallServiceOptions): Promise<ServicePeopleServiceGetRandomReturns> => {
            return callServiceMethod(
                host,
                "/ella/http/PeopleService/GetRandom",
                "POST",
                args,
                false,
                opts);
